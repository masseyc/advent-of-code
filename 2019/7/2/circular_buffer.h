...
int circular_buf_get(cbuf_handle_t cbuf, int * data);
...
//TODO: int circular_buf_get_range(circular_buf_t cbuf, int *data, size_t len);
//TODO: int circular_buf_put_range(circular_buf_t cbuf, int * data, size_t len);
